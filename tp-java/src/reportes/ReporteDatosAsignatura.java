...
/**
 * Clase que se encarga de generar el reporte de una asignatura.
 * Filtra las asignaturas por codigo y nombre.
 * Luego muestra los resultados en una tabla genérica.
...
public class ReporteDatosAsignatura {
        ...
        public void exportar(String codigoAsignatura, java.nio.file.Path ruta) throws java.io.IOException, DatoInvalidoException {
