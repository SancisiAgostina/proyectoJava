            ...
            if (rutaEncontrada == null) {
                ...
                try {
                    ...
                    if (informe != null && informe.hayErrores()) {
                        System.out.println("Se encontraron errores de validación en algunos registros de " + rutaEncontrada);
                        // No activamos huboErroresAlCargar para permitir que se guarde la versión limpia y ordenada al salir.
                        ...
                        Platform.runLater(() -> {
                            ...
                            alert.setContentText("Los registros correctos fueron cargados con éxito. Se guardará una versión limpia y ordenada de los datos al cerrar.");

                            javafx.scene.control.TextArea textArea = new javafx.scene.control.TextArea(informe.toString());
                    ...
                    Platform.runLater(() -> {
                        ...
                        alert.setContentText("El archivo contiene un error crítico de sintaxis o no se pudo leer. Se inició una universidad vacía. El guardado automático está desactivado.");
